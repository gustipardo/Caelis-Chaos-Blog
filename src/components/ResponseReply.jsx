...
export const ResponseReply = ({response_id, content, username}) => {
    ...
    return (
        <Button type="secondary" shape="circle" icon={Comment} onClick={() => handleClick()}/>
    )
}