...
import 'kleur/colors';
import 'html-escaper';
import { b as $$ViewTransitions, c as $$Navbar, a as $$Footer } from './pages/404_8gciT1cH.mjs';
/* empty css                         */
import { c as comparePostsByDate } from './pages/index_g-pI4aco.mjs';
/* empty css                                */
...
const $$PostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/posts/Thebeginning.mdx": () => import('./pages/Thebeginning_Blwx8ibF.mjs').then(n => n.T)}), () => "../pages/posts/*.mdx");
