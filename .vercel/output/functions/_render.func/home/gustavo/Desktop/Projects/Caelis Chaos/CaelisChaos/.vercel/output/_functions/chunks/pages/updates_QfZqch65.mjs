...
import { c as comparePostsByDate, $ as $$Post } from './index_g-pI4aco.mjs';
/* empty css                            */
...
const $$Updates = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Updates;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./posts/Thebeginning.mdx": () => import('./Thebeginning_Blwx8ibF.mjs').then(n => n.T)}), () => "../pages/posts/*.mdx");
